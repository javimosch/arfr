...
module.exports = {
    init: (data) => {
        ...
        logger.debugTerminal('signalName', data.signalName);
        ...
        co(function*() {
            ...
            //logger.debugTerminal('WATCH ROOT',root.val())
        }).catch((err) => {
    ...
    sendSignal: (evt, extraPayload) => {
        ...
        logger.debugTerminal('sending signal to ' + heConfig().signalName || heConfig().appName, JSON.stringify(payload));
